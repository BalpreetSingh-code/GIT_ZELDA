...
import PlayerPotLiftingState from "../states/entity/player/PlayerPotLiftingState.js";
import PlayerPotCarryingState from "../states/entity/player/PlayerPotCarryingState.js";
import PlayerPotThrowingState from "../states/entity/player/PlayerPotThrowingState.js";
...
export default class Player extends GameEntity {
  ...
  constructor() {
     ...
     */
    this.hitboxOffsets = new Hitbox(3, Player.HEIGHT, -6, -Player.HEIGHT + 6);
  ...
  initializeStateMachine() {
    ...
    stateMachine.add(
      PlayerStateName.PotLifting,
      new PlayerPotLiftingState(this)
    );
    stateMachine.add(
      PlayerStateName.PotCarrying,
      new PlayerPotCarryingState(this)
    );
    stateMachine.add(
      PlayerStateName.PotThrowing,
      new PlayerPotThrowingState(this)
    );
